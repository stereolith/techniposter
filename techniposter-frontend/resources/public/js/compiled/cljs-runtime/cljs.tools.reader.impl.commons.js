...
var G__56350 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__56350;
continue;
} else {
return ch;
...
var vec__56313 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56313,(0),null);
return (match === s);
});
...
var len__4736__auto___56391 = arguments.length;
var i__4737__auto___56392 = (0);
while(true){
if((i__4737__auto___56392 < len__4736__auto___56391)){
args__4742__auto__.push((arguments[i__4737__auto___56392]));

var G__56395 = (i__4737__auto___56392 + (1));
i__4737__auto___56392 = G__56395;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq56337){
...
return (function() { 
var G__56400__delegate = function (rdr,_){
...
var G__56400 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__56402__i = 0, G__56402__a = new Array(arguments.length -  1);
while (G__56402__i < G__56402__a.length) {G__56402__a[G__56402__i] = arguments[G__56402__i + 1]; ++G__56402__i;}
  _ = new cljs.core.IndexedSeq(G__56402__a,0,null);
} 
return G__56400__delegate.call(this,rdr,_);};
G__56400.cljs$lang$maxFixedArity = 1;
G__56400.cljs$lang$applyTo = (function (arglist__56403){
var rdr = cljs.core.first(arglist__56403);
var _ = cljs.core.rest(arglist__56403);
return G__56400__delegate(rdr,_);
});
