...
var len__4736__auto___55221 = arguments.length;
var i__4737__auto___55222 = (0);
while(true){
if((i__4737__auto___55222 < len__4736__auto___55221)){
args__4742__auto__.push((arguments[i__4737__auto___55222]));

var G__55223 = (i__4737__auto___55222 + (1));
i__4737__auto___55222 = G__55223;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__55128_55225 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__55129_55226 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__55130_55227 = true;
var _STAR_print_fn_STAR__temp_val__55131_55228 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__55130_55227);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__55131_55228);

try{var _STAR_print_level_STAR__orig_val__55132_55229 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__55133_55230 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__55133_55230);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__55132_55229);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__55129_55226);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__55128_55225);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq55125){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq55125));
}));
...
var new_formatters = current_formatters.filter((function (p1__55172_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__55172_SHARP_)));
}));
...
var G__55177_55257 = f;
var target__53376__auto___55258 = G__55177_55257;
if(cljs.core.truth_(target__53376__auto___55258)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__55177_55257)].join(''),"\n","target__53376__auto__"].join('')));
}

(target__53376__auto___55258["toString"] = (function (){
...
var G__55182_55261 = "%c%s";
var G__55183_55262 = "color:transparent";
var G__55184_55263 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__55182_55261,G__55183_55262,G__55184_55263) : f.call(null,G__55182_55261,G__55183_55262,G__55184_55263));
...
var args__4742__auto__ = [];
var len__4736__auto___55268 = arguments.length;
var i__4737__auto___55269 = (0);
while(true){
if((i__4737__auto___55269 < len__4736__auto___55268)){
args__4742__auto__.push((arguments[i__4737__auto___55269]));

var G__55270 = (i__4737__auto___55269 + (1));
i__4737__auto___55269 = G__55270;
continue;
} else {
}
break;
...
var vec__55195 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55195,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55195,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__55272__delegate = function (add_fmt,add_args){
...
var G__55272 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__55273__i = 0, G__55273__a = new Array(arguments.length -  1);
while (G__55273__i < G__55273__a.length) {G__55273__a[G__55273__i] = arguments[G__55273__i + 1]; ++G__55273__i;}
  add_args = new cljs.core.IndexedSeq(G__55273__a,0,null);
} 
return G__55272__delegate.call(this,add_fmt,add_args);};
G__55272.cljs$lang$maxFixedArity = 1;
G__55272.cljs$lang$applyTo = (function (arglist__55274){
var add_fmt = cljs.core.first(arglist__55274);
var add_args = cljs.core.rest(arglist__55274);
return G__55272__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq55190){
var G__55191 = cljs.core.first(seq55190);
var seq55190__$1 = cljs.core.next(seq55190);
var G__55192 = cljs.core.first(seq55190__$1);
var seq55190__$2 = cljs.core.next(seq55190__$1);
var G__55193 = cljs.core.first(seq55190__$2);
var seq55190__$3 = cljs.core.next(seq55190__$2);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55191,G__55192,G__55193,seq55190__$3);
}));
...
var seq__55203 = cljs.core.seq(features);
var chunk__55204 = null;
var count__55205 = (0);
var i__55206 = (0);
while(true){
if((i__55206 < count__55205)){
var feature = chunk__55204.cljs$core$IIndexed$_nth$arity$2(null,i__55206);
...
var G__55279 = seq__55203;
var G__55280 = chunk__55204;
var G__55281 = count__55205;
var G__55282 = (i__55206 + (1));
seq__55203 = G__55279;
chunk__55204 = G__55280;
count__55205 = G__55281;
i__55206 = G__55282;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__55203);
if(temp__5735__auto__){
var seq__55203__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__55203__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__55203__$1);
var G__55286 = cljs.core.chunk_rest(seq__55203__$1);
var G__55287 = c__4556__auto__;
var G__55288 = cljs.core.count(c__4556__auto__);
var G__55289 = (0);
seq__55203 = G__55286;
chunk__55204 = G__55287;
count__55205 = G__55288;
i__55206 = G__55289;
continue;
} else {
var feature = cljs.core.first(seq__55203__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__55294 = cljs.core.next(seq__55203__$1);
var G__55295 = null;
var G__55296 = (0);
var G__55297 = (0);
seq__55203 = G__55294;
chunk__55204 = G__55295;
count__55205 = G__55296;
i__55206 = G__55297;
continue;
}
} else {
...
var G__55212 = feature;
var G__55212__$1 = (((G__55212 instanceof cljs.core.Keyword))?G__55212.fqn:null);
switch (G__55212__$1) {
...
if(cljs.core.truth_(temp__5733__auto__)){
var o55215 = temp__5733__auto__;
return (o55215["version"]);
} else {
return null;
}
})() == null);
