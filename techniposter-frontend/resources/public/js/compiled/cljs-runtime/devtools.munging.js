...
var o53681 = temp__5733__auto__;
var temp__5733__auto____$1 = (o53681["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o53682 = temp__5733__auto____$1;
return (o53682["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__53361__auto__ = f;
return (o__53361__auto__["toString"]).call(o__53361__auto__);
} else {
return "";
}
}catch (e53690){var _ = e53690;
return "";
}});
...
try{var o__53361__auto___53907 = t;
(o__53361__auto___53907["cljs$lang$ctorPrWriter"]).call(o__53361__auto___53907,t,writer);
}catch (e53698){var __53908 = e53698;
}
...
var char_code = (function (){var o__53361__auto__ = (new String(char$));
return (o__53361__auto__["charCodeAt"]).call(o__53361__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__53361__auto__ = String;
return (o__53361__auto__["fromCharCode"]).call(o__53361__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__53711 = num_code;
switch (G__53711) {
case (1):
return (185);
...
var o__53361__auto__ = String;
return (o__53361__auto__["fromCharCode"]).call(o__53361__auto__,superscript_code);
});
/**
...
}catch (e53727){var _e__53383__auto__ = e53727;
return false;
}})())){
...
var vec__53732 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53732,(0),null);
...
var len__4736__auto___53923 = arguments.length;
var i__4737__auto___53924 = (0);
while(true){
if((i__4737__auto___53924 < len__4736__auto___53923)){
args__4742__auto__.push((arguments[i__4737__auto___53924]));

var G__53925 = (i__4737__auto___53924 + (1));
i__4737__auto___53924 = G__53925;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__53756){
var vec__53757 = p__53756;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53757,(0),null);
...
var G__53926 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__53927 = cljs.core.butlast(remaining_tokens);
name_tokens = G__53926;
remaining_tokens = G__53927;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq53749){
var G__53750 = cljs.core.first(seq53749);
var seq53749__$1 = cljs.core.next(seq53749);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__53750,seq53749__$1);
}));
...
var vec__53764 = cljs.core.split_with((function (p1__53763_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__53763_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53764,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53764,(1),null);
...
var vec__53779 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53779,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53779,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__53930 = cljs.core.rest(remaining_tokens);
var G__53931 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__53930;
name_tokens = G__53931;
continue;
} else {
...
var vec__53786 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53786,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53786,(1),null);
var vec__53789 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53789,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53789,(1),null);
var vec__53792 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53792,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53792,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53792,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53792,(3),null);
...
var vec__53805 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53805,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53805,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53805,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53805,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53805,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53805,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__53809 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53809,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53809,(1),null);
var vec__53812 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53812,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53812,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__53820 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__53820) : devtools.munging.parse_fn_info_deep.call(null,G__53820));
})()));
}
} else {
return fn_info;
...
var G__53952 = (arity + (1));
var G__53953 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__53827){
var vec__53828 = p__53827;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53828,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53828,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53832_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__53832_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53833_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__53833_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___53965 = arguments.length;
var i__4737__auto___53966 = (0);
while(true){
if((i__4737__auto___53966 < len__4736__auto___53965)){
args__4742__auto__.push((arguments[i__4737__auto___53966]));

var G__53967 = (i__4737__auto___53966 + (1));
i__4737__auto___53966 = G__53967;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__53843){
var vec__53844 = p__53843;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53844,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq53838){
var G__53839 = cljs.core.first(seq53838);
var seq53838__$1 = cljs.core.next(seq53838);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__53839,seq53838__$1);
}));
...
var G__53851 = arg;
var G__53851__$1 = (((G__53851 instanceof cljs.core.Keyword))?G__53851.fqn:null);
switch (G__53851__$1) {
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53860__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53860__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53860__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53860__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__53861 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53861,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53861,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53861,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53861,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53861,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53861,(5),null);
...
var o__53361__auto__ = f;
return (o__53361__auto__["getBasis"]).call(o__53361__auto__);
});
/**
...
}catch (e53868){var _e__53383__auto__ = e53868;
...
var G__53979 = (obj[cljs.core.first(path)]);
var G__53980 = cljs.core.rest(path);
obj = G__53979;
path = G__53980;
continue;
} else {
...
var _STAR_ = (function (accum,p__53880){
var vec__53881 = p__53880;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53881,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53881,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__53887){
var vec__53888 = p__53887;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53888,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53888,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53888,(2),null);
...
var post_process = (function (p__53897){
var vec__53899 = p__53897;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53899,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53899,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53892_SHARP_){
return (obj[cljs.core.first(p1__53892_SHARP_)]);
}),sorted_matches);
