...
var G__63650 = o;
goog.object.set(G__63650,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__63688__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__63688 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__63689__i = 0, G__63689__a = new Array(arguments.length -  0);
while (G__63689__i < G__63689__a.length) {G__63689__a[G__63689__i] = arguments[G__63689__i + 0]; ++G__63689__i;}
  args = new cljs.core.IndexedSeq(G__63689__a,0,null);
} 
return G__63688__delegate.call(this,args);};
G__63688.cljs$lang$maxFixedArity = 0;
G__63688.cljs$lang$applyTo = (function (arglist__63690){
var args = cljs.core.seq(arglist__63690);
return G__63688__delegate(args);
});
G__63688.cljs$core$IFn$_invoke$arity$variadic = G__63688__delegate;
return G__63688;
})()
;
} else {
...
var G__63654 = o;
goog.object.set(G__63654,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__63695__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__63695 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__63696__i = 0, G__63696__a = new Array(arguments.length -  0);
while (G__63696__i < G__63696__a.length) {G__63696__a[G__63696__i] = arguments[G__63696__i + 0]; ++G__63696__i;}
  args = new cljs.core.IndexedSeq(G__63696__a,0,null);
} 
return G__63695__delegate.call(this,args);};
G__63695.cljs$lang$maxFixedArity = 0;
G__63695.cljs$lang$applyTo = (function (arglist__63697){
var args = cljs.core.seq(arglist__63697);
return G__63695__delegate(args);
});
G__63695.cljs$core$IFn$_invoke$arity$variadic = G__63695__delegate;
return G__63695;
})()
;
} else {
...
var G__63656 = props;
var G__63656__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__63656,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__63656);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__63656__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__63656__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__63658 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__63658,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__63658;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__63664){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63665__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__63667_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__63667_SHARP_);
}));
} else {
return null;
}
...
var vec__63669 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63669,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63669,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63669,(2),null);
...
var temp__5739__auto___63716 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___63716 == null)){
} else {
var key_63718 = temp__5739__auto___63716;
...
var temp__5739__auto___63729 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___63729 == null)){
} else {
var key_63730 = temp__5739__auto___63729;
(jsprops.key = key_63730);
}
...
var G__63677 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__63677) : reagent.impl.template.as_element.call(null,G__63677));
} else {
var temp__5739__auto___63737 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___63737 == null)){
} else {
var key_63738 = temp__5739__auto___63737;
(jsprops.key = key_63738);
}
...
var G__63679 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__63679)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__63679)){
return x;
} else {
...
var len__4736__auto___63742 = arguments.length;
var i__4737__auto___63743 = (0);
while(true){
if((i__4737__auto___63743 < len__4736__auto___63742)){
args__4742__auto__.push((arguments[i__4737__auto___63743]));

var G__63745 = (i__4737__auto___63743 + (1));
i__4737__auto___63743 = G__63745;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq63680){
var G__63681 = cljs.core.first(seq63680);
var seq63680__$1 = cljs.core.next(seq63680);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__63681,seq63680__$1);
}));
...
var ctx = ({});
var vec__63684 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63684,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63684,(1),null);
...
var G__63687 = (cljs.core.count(argv) - first_child);
switch (G__63687) {
case (0):
