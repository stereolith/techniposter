...
var len__4736__auto___54020 = arguments.length;
var i__4737__auto___54021 = (0);
while(true){
if((i__4737__auto___54021 < len__4736__auto___54020)){
args__4742__auto__.push((arguments[i__4737__auto___54021]));

var G__54022 = (i__4737__auto___54021 + (1));
i__4737__auto___54021 = G__54022;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq53968){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__53969,G__53970,seq53968__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__53986_SHARP_){
return (!((cljs.core.meta(p1__53986_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53995__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e54001){var _e__53383__auto__ = e54001;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e54004){var _e__53383__auto__ = e54004;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__54012 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__54013 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__54013);

try{var map__54014 = opts;
var map__54014__$1 = (((((!((map__54014 == null))))?(((((map__54014.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54014.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__54014):map__54014);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54014__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__54012);
}});
...
var temp__5733__auto___54046 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___54046)){
var managed_print_level_54047 = temp__5733__auto___54046;
var _STAR_print_level_STAR__orig_val__54017_54048 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__54018_54049 = managed_print_level_54047;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__54018_54049);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__54016_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__54016_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__54017_54048);
}} else {
job_fn();
}
