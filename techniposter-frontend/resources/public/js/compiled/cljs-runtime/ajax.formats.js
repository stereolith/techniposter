...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__42061){
...
var request = map__42062__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42062__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__42067 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__42067.cljs$core$IFn$_invoke$arity$1 ? fexpr__42067.cljs$core$IFn$_invoke$arity$1(response) : fexpr__42067.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__42068 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__42068.cljs$core$IFn$_invoke$arity$1 ? fexpr__42068.cljs$core$IFn$_invoke$arity$1(response) : fexpr__42068.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__42069){
...
var request = map__42070__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42070__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
