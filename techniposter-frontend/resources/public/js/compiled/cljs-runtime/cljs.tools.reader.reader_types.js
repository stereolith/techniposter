...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_56114 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_56114(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_56122 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_56122(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_56134 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_56134(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_56139 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_56139(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_56140 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_56140(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_56147 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_56147(reader);
}
});
...
var G__56219 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__56220 = s.append(c);
c = G__56219;
s = G__56220;
continue;
}
